    ...
    <div className="flex flex-col h-screen bg-brand-dark text-white relative">
      ...
      <div className="bg-brand-surface px-4 py-3 border-b border-slate-700 shadow-md z-10 flex justify-between items-center">
         <div className="flex items-center space-x-4">
             ...
             <div className="px-3 py-1 bg-slate-800 rounded-md border border-slate-600">
                 <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Par {DEFAULT_PAR}</span>
             </div>
         </div>
      </div>
         ...
         <div className="max-w-md mx-auto flex justify-between items-center">
             ...
             <button 
                ...
                className={`w-12 h-12 rounded-full border flex items-center justify-center active:scale-95 transition-all ${
                    viewHole === activeRound.holeCount
